...
(ns ^{:doc    "Clojure package     lv.yu.clz
    ...
    lv.yu.clz.CLO-07-internal-frame-six  ;;  CLO-07-internal-frame-six demonstrates Clojure six Internal Frames
...
;;------------------------------   
    ...
    (def title (str "CLOJURE -- CLO_07_internal_frame_six -- v. 2023.01.01"))
